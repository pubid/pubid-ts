...
Bootstrap: the corpus loader, quadrant runner and CI harness are live;
identifier implementations land wave by wave (core model → parser
engine → builder → normalizer → renderer → urn → iso → iec → …).
